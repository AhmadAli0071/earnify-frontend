...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-950">
      <Navbar />
      
      <div className="flex-grow flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <Card className="w-full max-w-md bg-black/30 backdrop-blur-xl border border-white/10">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button variant="outline" type="button" className="w-full bg-white/5 text-white border-white/10 hover:bg-white/10">
          ...
          <CardFooter className="flex justify-center bg-black/20">
