    ...
    <AdminLayout>
      <div className="space-y-6">
                  ...
                  <CardContent className="p-6">
                    <div className="flex justify-between">
                      <div>
                        ...
                        <p className="text-2xl font-bold mt-1 text-gray-200">{stat.value}</p>
                      ...
                      <div className={`h-14 w-14 rounded-lg bg-gradient-to-br ${stat.color} bg-opacity-70 flex items-center justify-center`}>
                        {stat.icon}
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          >
            <Card className="bg-gray-900 border-gray-800 overflow-hidden">
              <CardHeader className="bg-gray-900/70 border-b border-gray-800 flex-row justify-between items-center pb-4">
        ...
        >
          <Card className="bg-gray-900 border-gray-800 overflow-hidden lg:col-span-2">
            <CardHeader className="bg-gray-900/70 border-b border-gray-800 flex-row justify-between items-center pb-4">
              <CardTitle className="text-lg font-medium flex items-center space-x-2">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-800">
                    <th className="text-left text-xs text-gray-500 px-6 py-3">USER</th>
                    <th className="text-left text-xs text-gray-500 px-6 py-3">AMOUNT</th>
                    <th className="text-left text-xs text-gray-500 px-6 py-3">METHOD</th>
                    <th className="text-left text-xs text-gray-500 px-6 py-3">REQUESTED</th>
                    <th className="text-left text-xs text-gray-500 px-6 py-3">ACTION</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-800">
                  {pendingWithdrawals.map((withdrawal) => (
                    ...
                    >
                      <td className="px-6 py-4 text-sm font-medium text-gray-200">{withdrawal.user}</td>
                      <td className="px-6 py-4 text-sm text-gray-200">{withdrawal.amount}</td>
          ...
          <Card className="bg-gray-900 border-gray-800 overflow-hidden">
            <CardHeader className="bg-gray-900/70 border-b border-gray-800 pb-4">
              <CardTitle className="text-lg font-medium flex items-center space-x-2">
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <motion.div variants={itemVariants} className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <p className="text-sm font-medium text-gray-200">78%</p>
                </div>
              ...
              <motion.div variants={itemVariants} className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <p className="text-sm font-medium text-gray-200">+12.4%</p>
                </div>
                <Progress value={62} className="h-2 bg-gray-800" />
              </motion.div>
              
              <motion.div variants={itemVariants} className="mt-4 pt-4 border-t border-gray-800">
